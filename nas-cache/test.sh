...
run_resolver "${TEST_ROOT}/custom.env" "go-custom" "npm-custom" "pip-custom"
...
run_resolver "${TEST_ROOT}/exact.env" "go-custom" "npm-custom" "pip-custom"
...
rm -rf "${base}/go/default" "${base}/npm/default" "${base}/pip/default"
